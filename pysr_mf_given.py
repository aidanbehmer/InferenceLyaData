...
with h5py.File(
    "../InferenceMultiFidelity/1pvar/lf_ns_npoints50_datacorrFalse.hdf5", "r"
) as file:
    print(file.keys())
...
with h5py.File(
    "../InferenceMultiFidelity/1pvar/hf_ns_npoints50_datacorrFalse.hdf5", "r"
) as file:
    print(file.keys())
...
param_fixed_low = np.quantile(params_low[:, param_idx], 0.16)
param_fixed_hi = np.quantile(params_hi[:, param_idx], 0.16)
