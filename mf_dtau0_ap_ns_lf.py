...
plt.title("True vs Predicted P1D for dtau0, Ap and ns")
plt.grid()
...
plt.xlabel("True P1D (normalized)")
plt.ylabel("Predicted P1D (normalized)")
plt.title("True vs Predicted P1D for dtau0, Ap and ns (colored by dtau0)")
...
plt.title("True vs Predicted P1D for dtau0, Ap and ns (denormalized)")
plt.grid()
...
plt.title("Relative Error as a Function of k for dtau0, Ap and ns ")
